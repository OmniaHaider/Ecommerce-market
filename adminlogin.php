...
if(isset($_POST['submit'])){
   ...
   if(mysqli_num_rows($select) > 0){
      ...
      header('location:Ecommerce-market/shop market/admin/index.php');
   }else{
...
<div class="form-container">
   ...
   <form action="/Ecommerce-market/shop market/admin/index.php" method="post">
      <h3>تسجيل الدخول</h3>
      ...
      <p>هل تملك حساب لدينا بالفعل؟ <a href="register.php"> حساب جديد</a></p>
   </form>
